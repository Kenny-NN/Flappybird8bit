...
#Laste inn bilder
bg = pygame.image.load("./Bilde/BGG.png")
bakke_bg = pygame.image.load("./Bilde/BakkeForSpillet.png")
linje_bg = pygame.image.load("./Bilde/Rulle.png")
...
class Superman():
    def __init__(self, x, y):
        img = pygame.image.load("./Bilde/Supermanflying1.png")
...
class Byggning(pygame.sprite.Sprite):
    def __init__(self, x, y, posisjon):
        ...
        img = pygame.image.load("./Bilde/Byggning.png")  
...
class Knapp():
    def __init__(self, x, y):
        img = pygame.image.load("./Bilde/Reset1.png")
